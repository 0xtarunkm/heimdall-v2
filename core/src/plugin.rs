...
#[derive(Default)]
pub struct HeimdallPlugin {
    publisher: Option<Publisher>,
    filter: Option<Vec<Filter>>,
}

impl Debug for HeimdallPlugin {
    fn fmt(&self, _: &mut Formatter<'_>) -> std::fmt::Result {
        Ok(())
    }
}

impl GeyserPlugin for HeimdallPlugin {
    ...
    fn build_transaction_event(
        ...
        TransactionEvent {
            ...
            transaction_status_meta: Some(TransactionStatusMeta {
                ...
                log_messages: transaction_status_meta
                    .log_messages
                    .clone()
                    .unwrap_or_default(),
                inner_instructions: transaction_status_meta
                    .inner_instructions
                    .clone()
                    .unwrap_or_default()
                    .into_iter()
                ...
                pre_token_balances: transaction_status_meta
                    .pre_token_balances
                    .clone()
                    .unwrap_or_default()
                    .into_iter()
                    ...
                    .collect(),
                post_token_balances: transaction_status_meta
                    .post_token_balances
                    .clone()
                    .unwrap_or_default()
                    .into_iter()
